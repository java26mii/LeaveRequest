 ...
 * @author HP
 */
public class JIApprovalHistory extends javax.swing.JInternalFrame {

    /**
     * Creates new form ApprovalLeave
     */
    public JIApprovalHistory() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Approval History");

        approvalTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "LEAVE_1", "Sindi", "05/01/2019", null}
            },
            new String [] {
                "No", "Leave Request ID", "Requester", "Request Date", "Status"
            }
        ));
    ...
    private void approvalTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_approvalTableMouseClicked
        approvalTable.getSelectedRows();
        JIHistoryDetail hd = new JIHistoryDetail();
        this.detailPanel.add(hd);
        hd.show();
