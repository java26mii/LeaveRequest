 ...
 */
public class JLoginEmail extends javax.swing.JFrame {
...
//            message.setContent(multipart);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JLoginEmail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JLoginEmail().setVisible(true);
            }
        });
    }
